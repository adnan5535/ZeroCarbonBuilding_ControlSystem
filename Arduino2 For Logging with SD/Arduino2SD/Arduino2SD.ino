...
byte mac[] = { 0xEE, 0xAD, 0xBE, 0xEF, 0xFE, 0xCD };
...
void loop() {
     ...
     */
     ...
     CTArray[0] = emon0.calcIrms(1282); //1480
    CTArray[1] = emon1.calcIrms(1282);
    CTArray[2] = emon2.calcIrms(1282);
    CTArray[3] = emon3.calcIrms(1282);
    CTArray[4] = emon4.calcIrms(1282);
    CTArray[5] = emon5.calcIrms(1282);
    CTArray[6] = emon6.calcIrms(1282);
    CTArray[7] = emon7.calcIrms(1282);
    CTArray[8] = emon8.calcIrms(1282);
    CTArray[9] = emon9.calcIrms(1282);
    CTArray[10] = emon10.calcIrms(1282);
    CTArray[11] = emon11.calcIrms(1282);
    CTArray[12] = emon12.calcIrms(1282);
    CTArray[13] = emon13.calcIrms(1282);
    CTArray[14] = emon14.calcIrms(1282);
    CTArray[15] = emon15.calcIrms(1282);
//    
    dataString_CTs = 
    ...
    String(CTArray[12]) + "," + String(CTArray[13]) + "," + String(CTArray[14]) + "," + String(CTArray[15]);
